...
- name: Data.gov API Get Datasets Badges
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/badges/master/_listings/datagov/datasets-badges-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/badges/master/_listings/datagov/datasets-badges-get-postman.md
x-common:
- type: x-blog
